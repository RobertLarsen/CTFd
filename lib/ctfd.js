...
CTFd.prototype.start = function() {
    ...
    if (this.webRouter) {
        require('./scoreswebpage')(this.webRouter, this.db);
        require('./statuswebpage')(this.webRouter, this.db);
...
CTFd.prototype.checkFlags_ = function() {
    ...
    this.db.flags.find({active:true, delivered:true, captures:{$size : 0}}).forEach(function(err, flag_doc) {
